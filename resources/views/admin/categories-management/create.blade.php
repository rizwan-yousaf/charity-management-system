...
@section('title', 'Smile Charities | Add Categories')
    ...
    <div class="row justify-content-center">
      <div class="col-md-10">
        <div class="card card-danger">
          ...
          <div class="card-body">
            <form action="/savecategories" method="POST" enctype="multipart/form-data">

              {{csrf_field()}}

              <div class="form-group">
                <label for="inputName">Category Type</label>
                <input type="text" id="inputName" class="form-control" placeholder="Enter Category Name" name="Category_type" required="true">
              </div>
