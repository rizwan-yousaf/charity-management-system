...
@section('title', 'Smile Charities | Users')
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <img class="profile-user-img img-fluid img-circle" src="/uploads/{{$user->avatar}}" alt="no image" style="height:100px; width:100px;">
                        </td>
                        <td>{{ $user->name }}</td>
                        <td>{{ $user->email }}</td>
