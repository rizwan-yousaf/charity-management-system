...
@section('content')
    ...
    <section class="content">
        ...
        @endif
    	<form action="/saveuserevent" method="POST" enctype="multipart/form-data">
    		{{csrf_field()}}
	      	<div class="row">
		        <div class="col-md-6">
			            ...
			            <div class="card-body">
			            	<div class="form-group">
			              	...
			              	<div class="form-group">
			                	...
			                	<input type="text" id="inputName" class="form-control" name="user_name" required="true">
			              	</div>
			              	<div class="form-group">
			                	<label for="inputName">User Email</label>
			                	<input type="email" id="inputName" class="form-control" name="user_email" required="true">
			              	</div>
				            <div class="form-group">
