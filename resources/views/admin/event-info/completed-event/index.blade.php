    ...
    <a href="/donate" class="btn btn-success"><i class="fa fa-plus"></i>  Donate Now For General Purpose</a>
  	...
  	<div class="card">
	    <div class="card-header">
	      	<h3 class="card-title">Completed Events List</h3>
							...
							?>
			              	<tr>
			                    ...
			                    <td class="project_progress">
			                  	...
			                  	<td class="project-state">
			                      	@if($row->Transfer_Fund == null)<span class="badge bg-danger">Fund Transfer Pending</span>@elseif($row->Transfer_Fund == 1)<span class="badge bg-success">Fund Transfer Successfully</span>@else<span class="badge bg-warning">Error</span>@endif
			                  	</td>
			                  	<td class="project-actions text-right">
			                  		<a class="btn btn-info btn-sm" href="/transfer-fund/{{$row->id}}">
			                          	<i class="fas fa-exchange-alt"></i>
			                          	Transfer Fund
			                      	</a>
			                      	&nbsp;
			                  	    <a class="btn btn-danger btn-sm" href="/deletecompletedevent/{{$row->id}}">
