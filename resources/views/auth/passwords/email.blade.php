        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="card abc13">
                    ...
                    <div class="card-body" style="margin-top: 10px;margin-right: 8px; margin-left: 8px;">
                        @if (session('status'))
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="form-group row" style="margin-top: 20px;margin-right: 4px; margin-left: 4px;">
