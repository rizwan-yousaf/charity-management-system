            ...
            <div class="row">
                ...
                <div class="col-md-7" style="margin-top: -30px">
                    ...
                    <div id="easypaisa" style="display: none;">
                        ...
                        <form action="{{route('commit-now')}}" method="Post">
                            {{ csrf_field() }}
                            <div class="section-title">
                            ...
                            <div class="form-group">
                                ...
                                <input class="input" placeholder="For What Purpose" type="text" name="purpose" required="true" style="outline: none;">
                            </div> 
                            <div class="form-group">
                    ...
                    <div id="card">
                        ...
                        <form accept-charset="UTF-8" action="{{route('amount-donated')}}" class="require-validation"
