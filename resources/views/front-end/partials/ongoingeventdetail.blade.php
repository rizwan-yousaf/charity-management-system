...
@section("title","Smile Charities | Ongoing Event Detail")
			...
			<div class="row">
				<div class="col-md-12">
					<div class="header-content">
						<div class="col-md-8">
							<h1>Ongoing Event Detail</h1>
							<ul class="breadcrumb">
								<li><a href="/">Home</a></li>
								<li><a href="/ongoingevent">Ongoing Events</a></li>
								@foreach($ongoing_event_details as $row)
				...
				@foreach($ongoing_event_details as $row)
					...
					<main id="main" class="col-md-9">
						...
						<div class="article causes-details">
							...
							<!-- causes progress -->
							<div class="clearfix" style="margin-right: 10px; margin-left: 15px;">
