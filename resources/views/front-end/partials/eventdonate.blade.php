...
@Section("title","Smile Charities | Donate Now")
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="header-content">
                        <div class="col-md-8"> 
                            <h1>Event Donation</h1>
                                <ul class="breadcrumb">
                                    <li><a href="/">Home</a></li>
                                    <li class="active">{{$eventamount->Title}}</li>
                                </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-4" style="margin-bottom: 100px;">
                    <a href="#" class="about-video">
                        <img src="/uploads/{{$eventamount->Image}}" alt="">
                    </a>
                    ...
                    <br>
                    <?php
                        $percent= ($eventamount->raised_fund/$eventamount->Fund )*100;
                    ...
                    <div class="causes-progress" style="margin-right: 10px; margin-left: 15px;">
                        ...
                        <div>
                            <span class="causes-raised">Raised: <strong>{{$eventamount->raised_fund}}Rs</strong></span>
                            <span class="causes-goal">Goal: <strong>{{$eventamount->Fund}}Rs</strong></span>
                        </div>
                    </div>
                </div>
                <!-- /about video -->
                ...
                <div class="col-md-7" style="margin-top: -30px">
                    ...
                    <div id="easypaisa" style="display: none;">
                        ...
                        <form action="{{route('checkout-now')}}" method="Post">
                            ...
                            <div class="form-group">
                                <input class="input" placeholder="Enter Full Name" type="hidden" name="event_id" required="true" style="outline: none;" value="{{$eventamount->id}}">
                            </div>
                            <div class="form-group">
                                <label class='control-label'>Your Name</label>
                                <input class="input" placeholder="Enter Full Name" type="text" name="name" required="true" style="outline: none;" value="{{ Auth::user()->name }}" readonly>
                            </div>
                            <div class="form-group">
                                <label class='control-label'>Your Email</label>
                                <input class="input" placeholder="Enter Email Adress" type="email"  name="email" required="true" style="outline: none;" value="{{ Auth::user()->email }}" readonly>
                            </div>
                            <div class="form-group">
                                <label class='control-label'>Your Phone No.</label>
                                <input class="input" placeholder="Enter Your Phone No." type="number" name="phone_no" required="true" style="outline: none;">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="input" placeholder="For What Purpose" type="text" name="purpose" required="true" style="outline: none;" value="{{$eventamount->Title}}" readonly>
                            </div> 
                            <div class="form-group">
                                <label class='control-label'>Amount(PKR)</label>
                                <input class="input" placeholder="Enter Your Donation" type="number" name="amount" required="true" style="outline: none;">
                            </div>
                            ...
                            <div class='form-group text-center'>
                                <div class='form-group ml-auto'>
                                    <button class="primary-button" style="outline: none;" type='submit' style="margin-top: 10px;">Commit Now</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div id="card">
                        ...
                        <form accept-charset="UTF-8" action="{{route('checkout')}}" class="require-validation"
                        ...
                        {{ csrf_field() }}
                            ...
                            <div class='form-group text-center'>
                                <div class='form-group ml-auto'>
                                    <button class="primary-button" style="outline: none;" type='submit' style="margin-top: 10px;">Donate Now</button>
                                </div>
                            </div>
                            <div class='form-row'>
